...
def get_rgb_texture(vae, uvp_rgb:UVP, latents):
	...
	textured_views_rgb, result_tex_rgb, visibility_weights = uvp_rgb.occ_bake_texture(views=result_views, main_views=[], exp=6, noisy=False)
